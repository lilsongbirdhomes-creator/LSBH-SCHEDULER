...
body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;background:linear-gradient(135deg,#ffd93d 0%,#ffeaa7 50%,#fff4cc 100%);min-height:100vh;padding:12px;}
...
.login-head{background:linear-gradient(135deg,#ffd93d,#ffb347);color:#2c3e50;padding:36px 28px;text-align:center;}
...
.fg input:not([type="hidden"]):focus,.fg select:focus{outline:none;border-color:#ffc107;}
.login-btn{width:100%;padding:13px;background:linear-gradient(135deg,#ffd93d,#ffb347);color:#2c3e50;border:none;border-radius:8px;font-size:15px;font-weight:600;cursor:pointer;}
...
.app-hdr{background:linear-gradient(135deg,#ffd93d,#ffb347);color:#2c3e50;padding:18px 22px;display:flex;justify-content:space-between;align-items:center;gap:12px;flex-wrap:wrap;}
...
.a-tab.active{color:#ffc107;border-bottom-color:#ffc107;}
...
.b-edit{background:#ffc107;color:white;}
...
.approval-item{background:white;border-radius:8px;padding:14px;margin-bottom:10px;border-left:4px solid #ffc107;}
...
.nav-arrow:hover{background:#ffc107;color:white;border-color:#ffc107;}
...
.v-btn.active{background:white;color:#ffc107;box-shadow:0 1px 4px rgba(0,0,0,.12);}
...
.mok{background:#ffc107;color:white;}
...
.stat-card{background:white;padding:14px;border-radius:8px;border-left:4px solid #ffc107;}
...
.spinner{width:40px;height:40px;border:4px solid #f3f3f3;border-top:4px solid #ffc107;border-radius:50%;animation:spin 1s linear infinite;}
...
.modal-content .inp:focus{outline:none;border-color:#ffc107;}
...
.b-pri{padding:8px 16px;background:#ffc107;color:white;border:none;border-radius:6px;font-size:13px;font-weight:600;cursor:pointer;}
...
.swap-btn:hover{background:#ffc107;}
...
.swap-arrow{align-self:center;font-size:24px;color:#ffc107;}
...
#toggleMyShiftsBtn:hover{border-color:#ffc107;}
...
.gen-tab.active{color:#ffc107;border-bottom-color:#ffc107;}
.gen-tab:hover{color:#ffc107;}
...
.gen-trigger-btn{padding:10px 20px;background:#ffc107;color:white;border:none;border-radius:8px;font-size:14px;font-weight:600;cursor:pointer;margin-bottom:16px;}
.gen-trigger-btn:hover{background:#5568d3;}
/* ADD THIS TO styles.css */

/* EXPORT/IMPORT BUTTONS */
.data-backup-section{margin:20px 0;padding:16px;background:#f8f9fa;border-radius:8px;border-left:4px solid #ffc107;}
...
.btn-import{background:#ffc107;color:white;}
...
#importFileInput:hover{border-color:#ffc107;background:#f8f9fa;}
...
.btn-request  { background: linear-gradient(135deg, #ffc107, #ffb347); }
...
.request-option-btn:hover { border-color: #ffc107; background: #f8f0ff; }
...
.tl-staff { font-size: 11px; color: #ffc107; font-weight: 600; }
.trade-arrow { display: flex; align-items: center; font-size: 22px; color: #ffc107; flex-shrink: 0; }
...
.inp-full:focus { outline: none; border-color: #ffc107; }
...
.prc-type  { font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: .6px; color: #ffc107; margin-bottom: 6px; }
...
.inbox-section-title {
  ...
  letter-spacing: .7px; color: #ffc107; margin-bottom: 10px;
}
.trade-inbox-card {
  border: 2px solid #dee2e6;
  border-radius: 10px;
...
.trade-inbox-card.incoming { border-color: #ffc107; }
...
.tic-arrow { display: flex; align-items: center; font-size: 18px; color: #ffc107; flex-shrink: 0; }
...
/* Spring Yellow Theme Adjustments */
.b-edit, .mok, .b-pri, .gen-trigger-btn, .btn-import {
  background: linear-gradient(135deg, #ffc107, #ffb347);
